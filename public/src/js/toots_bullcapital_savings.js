window.onload = function() {
	if (window.jQuery) {
		...
		var fh = '<div>' +
			...
			'<div class="col-md-3"><label>Данс нээх мөнгөн дүн</label>' +
			'<div class="form-group">' +
			...
			'</div>' +
			'<div class="col-md-3"><label>Сар бүр нэмэх дүн</label>' +
		...
		function savingForm(data) {
			...
			var text = 'Та <span class="gs-text">' + first + '</span> хэмжээний төгрөгийг сар бүр ' +
				'<span class="gs-text">' + plus + '</span> төгрөг дансанд нэмэгдэх орлоготой, жилийн ' +
				'<span class="gs-text">' + perc + '%</span>-ийн хүүтэйгээр хадгалуулснаар, ' +
				'<span class="gs-text">' + month + '</span> сарын дараа таны хадгаламж ' +
				'<span class="gs-text">' + numeral(t).format('0,00.00') + '<small class="mnt">₮</small></span> болж өснө.';
			var panel = '<div class="row panel-gutters">' +
				'<div class="col-md-4"><div class="gs-panel"><span>Нийт мөнгөн дүн</span><h4>' + numeral(t).format('0,00') + '<small class="mnt">₮</small></h4></div></div>' +
				'<div class="col-md-4"><div class="gs-panel"><span>Хуримтлуулсан мөнгө</span><h4>' + numeral(s).format('0,00') + '<small class="mnt">₮</small></h4></div></div>' +
				'<div class="col-md-4"><div class="gs-panel"><span>Цуглуулсан хүү</span><h4>' + numeral(dp).format('0,00') + '<small class="mnt">₮</small></h4></div></div>' +
				'</div>'
