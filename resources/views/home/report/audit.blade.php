...
<section class="page-title">
  <div class="auto-container">
    <div class="title-outer">
      <h1>САНХҮҮГИЙН АУДИТЫН ТАЙЛАН</h1>
      <ul class="page-breadcrumb">
        <li><a href="/">Нүүр</a></li>
        <li><a href="/report">ТАЙЛАН</a></li>
        <li>САНХҮҮГИЙН АУДИТЫН ТАЙЛАН</li>
      </ul>
    </div>
  </div>
</section>
        ...
        <div class="ls-outer">
            ...
            <div class="default-tabs tabs-box">
                ...
                <div class="tab active-tab" id="2022">
                    <div class="row">
                    <embed src="{{ asset('src/files/financial-audit-report-2022.pdf') }}" type="application/pdf" width="100%" height="600px" />
                    </div>
                </div>
